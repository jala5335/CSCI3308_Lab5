...
function loadStatsPage(){
	...
	var oppteam; // kepps track of opposite team name
	var wteam; // winning team name
	var cell_value; 
	var score1; // first score
	var score2; // second score
	var winc = 0; // person who won the game
	var lossc = 0;
	var wint;
	var losst;
		...
		for(col_counter = 0; col_counter < table.rows[row_counter].cells.length; col_counter++)
		{
			...
			if(col_counter == 4){
				if(score1 > score2){
					wteam = "Cu Boulder";
					winc = winc + 1;
					table.rows[row_counter].cells[col_counter].innerHTML = wteam;
				}
				else{
					wteam = oppteam;
					lossc = lossc + 1;
	...
	wint = document.getElementById("wins");
	wint.innerHTML = winc;
	losst = document.getElementById("losses")
	losst.innerHTML = lossc;
}
